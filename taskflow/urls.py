...
urlpatterns = [
    ...
    #Memeber Management
    path("projects/<int:project_id>/members/add/", views.project_add_member_view, name="project-add-member"),
    path("projects/<int:project_id>/members/<int:membership_id>/remove/", views.project_remove_member_view, name="project-remove-member"),
    path("projects/<int:project_id>/members/<int:membership_id>/update-role/", views.project_update_member_role_view, name="project-update-member-role"),
]
